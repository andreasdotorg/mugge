...
| US-076 | DECOMPOSE | 0/5 | **Filed 2026-03-24.** Color palette migration: CSS variable consolidation, navy background, JS hardcoded color removal, mode badge differentiation (amber DJ / cyan Live), managed-node cyan highlight. UX specialist preparing implementation checklist. |
