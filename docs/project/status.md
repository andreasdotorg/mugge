...
| US-004 | REVIEW | 4/4 | in-review (assumption register covers A1-A28, cross-references documented, CLAUDE.md updated. A27 gap resolved — was stale CLAUDE.md reference). Pending owner acceptance. |
...
| US-050 | IMPLEMENT | 5/6 | **unblocked** (US-060 VERIFY PASS 2026-03-21). CI tier done, E2E tier can now proceed with D-040 adaptation. |
| US-051 | IMPLEMENT | 2/4 | **unblocked** (US-060 VERIFY PASS 2026-03-21). UI structure done (SB-1-7), data source wiring can now proceed. |
...
| US-059 | REVIEW | **14/14** | **REVIEW phase (fast-tracked 2026-03-21).** QE approved DEPLOY/VERIFY fast-track: accumulated evidence (GM-12, C-006, D-001, O-018 13h39m soak, S-001/S-002) exceeds single-session VERIFY. 168 regression tests pass, all 14 DoD items satisfied. Follow-ups: F-033, I-1 CI wiring, spectral verification (AC 3141), D-042 lifting. **Pending: advisory sign-offs + owner acceptance.** |
| US-060 | VERIFY | 2/7 | **VERIFY PASS** (S-002 2026-03-21). FilterChainCollector running, GraphManager RPC working, 0 xruns. US-050/US-051 unblocked. Known gap: webui service needs PI4AUDIO_MEAS_DIR env var committed to repo. |
| US-061 | VERIFY | 1/8 | **VERIFY PASS** (S-002 2026-03-21). Client files deployed, imports OK on Pi. Known gaps: deploy.py has old CamillaDSP coeffs path, measure_nearfield.py has pycamilladsp imports in git source. |
...
- **US-059** (Phase: **REVIEW, DoD 14/14** — fast-tracked to REVIEW 2026-03-21): GraphManager Core + Production Filter-Chain (Phase A). **DoD: 14/14 — ALL ITEMS SATISFIED.** QE approved DEPLOY/VERIFY fast-track: accumulated deployment evidence (GM-12 40min DJ session, C-006 config deployment, D-001 6-iteration reboot test, O-018 13h39m soak, S-001/S-002 VERIFY sessions) exceeds single-session VERIFY requirements. System running in production since 2026-03-20 with zero steady-state xruns. **Tracked follow-ups:** F-033 (Reaper JACK bridge RT), I-1 CI wiring, spectral verification (AC line 3141), D-042 lifting (q256 stability). GM tasks: 14/15 (GM-8 CamillaDSP removal tracked separately). HEAD: `5fbd5f7`. **Next: collect advisory sign-offs per review matrix, then owner acceptance.**
...
- **US-060** (Phase: **VERIFY, DoD 2/7** — S-002 PASS 2026-03-21): PipeWire Monitoring Replacement (Phase B). FilterChainCollector running, GraphManager RPC working, 0 xruns. US-050/US-051 unblocked. Known gap: webui service needs PI4AUDIO_MEAS_DIR env var committed to repo.
- **US-061** (Phase: **VERIFY, DoD 1/8** — S-002 PASS 2026-03-21): Measurement Pipeline Adaptation (Phase C). Client files deployed, imports OK on Pi. Known gaps: deploy.py has old CamillaDSP coeffs path in git, measure_nearfield.py has pycamilladsp imports in git source.
- **US-050** (ACTIVE — **unblocked** by US-060 VERIFY PASS): Measurement Pipeline Mock Backend. CI tier done, E2E tier can now proceed with D-040 adaptation.
- **US-051** (ACTIVE — **unblocked** by US-060 VERIFY PASS): Persistent System Status Bar. UI structure done (SB-1-7), data source wiring can now proceed.
...
- **US-004** (in-review, DoD **4/4**): Assumption register (A1-A28). A27 gap resolved — stale CLAUDE.md reference corrected. Pending owner acceptance.
