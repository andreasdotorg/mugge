...
- **US-051** (selected, owner-authorized 2026-03-15): Persistent system status bar with channel meters. Subsumes TK-225/226/227. Decomposed into SB-1 through SB-7 (7 subtasks, 5 layers). Critical path: SB-1 → SB-3 → SB-6 → SB-7. UX spec complete (`persistent-status-bar.md`). Implementation starting with SB-1 (HTML/CSS scaffold).
- **US-052** (selected, owner-authorized 2026-03-15; blocked): Real-time signal generator in Rust. Blocked on TK-151 (pcm-bridge Pi validation / AD-F006) and D-037 design approval (v3 in re-verification by Security/AE/AD). Supersedes TK-229. Blocks US-053, US-047, US-012.
