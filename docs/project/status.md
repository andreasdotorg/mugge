...
- **US-051** (code complete, pending Pi validation): Persistent system status bar with channel meters. SB-1 through SB-6 DONE. SB-7 Phase A PASS (12/12 code review checks). SB-7 Phase B (live Pi testing) blocked on Pi deployment — queues behind TK-151 nix build chain.
- **US-052** (selected, owner-authorized 2026-03-15; partially blocked): Real-time signal generator in Rust. D-037 APPROVED by Security/AE/AD (TK-234 DONE). Still blocked on TK-151 (pcm-bridge Pi validation / AD-F006). Supersedes TK-229. Blocks US-053, US-047, US-012.
