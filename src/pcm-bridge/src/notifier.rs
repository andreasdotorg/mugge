//! RT-safe event notification for waking server threads from the PW callback.
//!
...
//!
//! Two independent flags allow the PCM broadcast and levels server
//! to wake independently from the same process callback.
