...
Scenarios:
    ...
    D - Failure:     Filter chain degraded, xruns climbing, degraded scheduling
...
SCENARIOS = {
    "A": {
        ...
        "pw_priority": 88,
        "graphmgr_policy": "SCHED_FIFO",
        "graphmgr_priority": 80,
        "cdsp_state": "Running",
        "processing_load": 5.0,
        "capture_rate": 48000,
        "playback_rate": 48000,
    ...
    def monitoring(self) -> dict:
        ...
        return {
            ...
            "camilladsp": {
                ...
                "gm_mode": s.get("gm_mode", s["mode"]),
                "gm_links_desired": s.get("gm_links_desired", 12),
                "gm_links_actual": s.get("gm_links_actual", 12),
                "gm_links_missing": s.get("gm_links_missing", 0),
                "gm_convolver": s.get("gm_convolver", "present"),
            },
        }
    ...
    def system(self) -> dict:
        ...
        return {
            ...
            "processes": {
                ...
                "graphmgr_cpu": self._proc_jitter(s["graphmgr_cpu"], t),
